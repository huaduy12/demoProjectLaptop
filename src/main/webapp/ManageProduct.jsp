                        ...
                        <div class="row element-button">
                          <div class="col-sm-2">
                           ...
                           <div class="col-sm-2">
	                			...
	                			<button class="btn btn-primary btn-sm" type="button" title="Thêm hãng sản xuất" 
                                     onclick="window.location.href='addCategory.jsp'"  ><i
	                    class="fas fa-folder-plus"></i> Thêm hãng sản xuất
                                      </button>
