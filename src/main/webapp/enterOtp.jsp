        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="login_form_inner register_form_inner">
              <h3>Nhập mã Otp của bạn</h3>
              <form class="row login_form" action="validateOtp" id="register_form" method="post">
                ...
                <div class="col-md-12 form-group">
                  ...
                  />
                  <c:if test="${messageOtp != null}">
                    <span  style="color: red;">Mã otp bạn nhập đang sai. Vui lòng nhập lại
                </span>
                  </c:if>
                  <span id="otp-error" class="error-message"
